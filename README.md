...
a. Automate the process of organising a multitude of files into a single objective-oriented report .
b. To analyze reports in order to elicit new information and output\append the analysis into the relevant report.
The scripts are:
...
2.Produce_PsychReportsV2.sh - Same as the former script, but improved to a produce a more oragnized and aestetic report, and to analyze the subject more extensively using several of Fabric's patterns to instruct the AI model on the analysis. 
